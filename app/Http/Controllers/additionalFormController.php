    ...
    public function store(Request $request)
{
    ...
    // Retrieve the bdu_id from basic_data_users table
    $basicDataUser = BasicFormModel::first(); // Change this to match your logic for retrieving basic data user
    if (!$basicDataUser) {
        // Handle the case when no basic data user is found
        // You may want to redirect or show an error message
        return redirect()->back()->with('error', 'No basic data user found.');
    }
