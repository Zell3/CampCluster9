            ...
            <form action="/form2/" method="POST" enctype="multipart/form-data">
                ...
                <div class = "container-item-left" style="width: 35%;">
                    <div>
                        ...
                        <input type="date" name="birthday" placeholder="กรุณากรอก" required><br>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="address" id="" cols="30" rows="5" placeholder="กรุณากรอก" required></textarea>
                    </div>
                    <div>
                        <label for="currentaddress">ที่อยู่ปัจจุบัน</label><br>
                        <textarea name="currentaddress" id="" cols="30" rows="5" placeholder="กรุณากรอก" required></textarea>
                    </div>
                </div>
                <div class = "container-item-right" style="width: 35%;">
                    <div>
                    ...
                    <div>
                        <label
                            for="emergency_contact_status">สถานะที่เกี่ยวข้องของบุคคลที่ติดต่อได้กรณีเร่งด่วน</label><br>
