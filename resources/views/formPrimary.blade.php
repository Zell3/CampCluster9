...
<div class="show-formPrimary">
    <div class="page d-flex justify-content-evenly align-items-center ">
        ...
        <div class="data ">
            ...
            <br>
            <label for="name">{{ $basicData->bdu_name }} {{ $basicData->bdu_lastname }}</label>
            <br>
            <br>
            <label for="email" class="label">อีเมล</label>
            <br>
            <label for="email">{{ $basicData->bdu_email }}</label>
            <br>
            <br>
            <label for="position" class="label">ตำแหน่ง</label>
            <br>
            <label for="position">{{ $basicData->role->ro_name }}</label>
            <br>
            <br>
            <label for="type" class="label">ประเภท</label>
            <br>
            <label for="type">{{ $basicData->bdu_working }}</label>
            <br>
            <br>
            <label for="phone" class="label">เบอร์โทรศัพท์</label>
            <br>
            <label for="phone">{{ $basicData->bdu_phone }}</label>
            <br>
            <br>
