        ...
        <div class="tools-flex-box">
            ...
            <div class="item">
                <div class="btn-email">
                    ...
                    <a href="#"><button class="btn-email-bg"><svg class="iconColor"
            ...
            <div class="item">
                ...
                <div class="searchBar">
                    ...
                    <button class=" btn-search-bg"><svg class="iconColor xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="item">
                ...
                <div class="filter">
                    <a href="#"><button class="btn-filter-bg"><svg class="iconColor"
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {{-- ใส่ลิงก์ฟอร์ม --}}
                    <td><a href="#"><button class="btn-link">ฟอร์มเพิ่มเติม</button></a></td>
                    <td><a href="#"><button class="btn-status-wait">Wait</button></a></td>
                </tr>
                <tr>
                    <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-pin-angle" viewBox="0 0 16 16">
                ...
                <tr>
                    ...
                    <td>libero</td>
                    {{-- ใส่ลิงก์ฟอร์ม --}}
                    <td><a style="text-decoration: none" href="#"><button
